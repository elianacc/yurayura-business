...
CREATE TABLE `yurayura_sys_dict` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8 COMMENT='系统数据字典';
...
CREATE TABLE `yurayura_sys_manager` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统管理员';

DROP TABLE IF EXISTS `yurayura_sys_manager_role`;
CREATE TABLE `yurayura_sys_manager_role` (
  `manager_id` int(12) NOT NULL COMMENT '管理员id',
  `role_id` int(12) NOT NULL COMMENT '角色id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='系统管理员-系统角色中间表';

DROP TABLE IF EXISTS `yurayura_sys_role`;
CREATE TABLE `yurayura_sys_role` (
  `id` int(12) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `role_name` varchar(30) NOT NULL COMMENT '角色名',
  `role_status` int(1) NOT NULL COMMENT '状态- 0：禁用，1：启用',
  `role_create_time` datetime NOT NULL COMMENT '创建时间',
  `role_update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='系统角色';

DROP TABLE IF EXISTS `yurayura_sys_role_permission`;
CREATE TABLE `yurayura_sys_role_permission` (
  `role_id` int(12) NOT NULL COMMENT '角色id',
  `permission_id` int(12) NOT NULL COMMENT '权限id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='系统角色-系统权限中间表';
...
CREATE TABLE `yurayura_sys_permission` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='系统权限';
...
CREATE TABLE `yurayura_sys_menu_sub` (
  ...
  `menu_status` int(1) NOT NULL COMMENT '状态- 0：隐藏，1：显示',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='系统子菜单';
...
CREATE TABLE `yurayura_comic` (
  ...
  `comic_score` double(5,1) NOT NULL COMMENT '评分',
  ...
  `comic_current_episodes` int(5) NOT NULL COMMENT '当前话数',
...
CREATE TABLE `yurayura_user` (
  ...
  `user_sex` int(1) DEFAULT NULL COMMENT '性别- 1：男，2：女',
...
INSERT INTO `yurayura_sys_dict` VALUES ('45', 'comicUpdtStatus', '已完结', '0', '1', '1');
INSERT INTO `yurayura_sys_dict` VALUES ('46', 'comicUpdtStatus', '更新中', '8', '1', '2');
INSERT INTO `yurayura_sys_dict` VALUES ('47', 'comicShelfStatus', '上架', '1', '1', '1');
INSERT INTO `yurayura_sys_dict` VALUES ('48', 'comicShelfStatus', '下架', '0', '1', '2');
INSERT INTO `yurayura_sys_dict` VALUES ('49', 'menuStatus', '显示', '1', '1', '1');
INSERT INTO `yurayura_sys_dict` VALUES ('50', 'menuStatus', '隐藏', '0', '1', '2');
INSERT INTO `yurayura_sys_dict` VALUES ('51', 'menuType', '一级菜单', '1', '1', '1');
INSERT INTO `yurayura_sys_dict` VALUES ('52', 'menuType', '二级菜单', '2', '1', '2');
INSERT INTO `yurayura_sys_dict` VALUES ('53', 'enableStatus', '启用', '1', '1', '1');
INSERT INTO `yurayura_sys_dict` VALUES ('54', 'enableStatus', '禁用', '0', '1', '2');
INSERT INTO `yurayura_sys_dict` VALUES ('55', 'permissionType', '菜单', '1', '1', '1');
INSERT INTO `yurayura_sys_dict` VALUES ('56', 'permissionType', '按钮', '2', '1', '2');
INSERT INTO `yurayura_sys_dict` VALUES ('57', 'userSex', '男', '1', '1', '1');
INSERT INTO `yurayura_sys_dict` VALUES ('58', 'userSex', '女', '2', '1', '2');

INSERT INTO `yurayura_sys_manager` VALUES ('1', 'admin', 'db69fc039dcbd2962cb4d28f5891aae1', '1', '2019-12-30 15:09:20', '2021-09-24 17:24:45');
INSERT INTO `yurayura_sys_manager` VALUES ('2', 'system', '87d9bb400c0634691f0e3baaf1e2fd0d', '1', '2022-03-08 17:06:10', '2022-03-09 10:54:40');
INSERT INTO `yurayura_sys_manager` VALUES ('3', 'business', '87d9bb400c0634691f0e3baaf1e2fd0d', '1', '2021-04-19 09:40:05', '2022-03-10 17:15:10');

INSERT INTO `yurayura_sys_manager_role` VALUES ('1', '1');
INSERT INTO `yurayura_sys_manager_role` VALUES ('2', '2');
INSERT INTO `yurayura_sys_manager_role` VALUES ('3', '3');
INSERT INTO `yurayura_sys_manager_role` VALUES ('3', '4');

INSERT INTO `yurayura_sys_role` VALUES ('1', '超级管理员', '1', '2022-03-07 10:54:53', null);
INSERT INTO `yurayura_sys_role` VALUES ('2', '系统模块管理员', '1', '2022-03-07 10:58:44', '2022-03-11 14:08:41');
INSERT INTO `yurayura_sys_role` VALUES ('3', '番剧模块管理员', '1', '2022-03-07 10:59:32', null);
INSERT INTO `yurayura_sys_role` VALUES ('4', '用户模块管理员', '1', '2022-03-07 11:00:02', null);

INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '1');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '2');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '3');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '4');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '5');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '6');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '7');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '8');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '9');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '10');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '11');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '12');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '13');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '14');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '15');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '16');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '17');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '18');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '19');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '20');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '21');
INSERT INTO `yurayura_sys_role_permission` VALUES ('1', '22');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '1');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '2');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '3');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '4');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '5');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '6');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '7');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '8');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '9');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '10');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '11');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '12');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '13');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '14');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '15');
INSERT INTO `yurayura_sys_role_permission` VALUES ('2', '16');
INSERT INTO `yurayura_sys_role_permission` VALUES ('3', '17');
INSERT INTO `yurayura_sys_role_permission` VALUES ('3', '18');
INSERT INTO `yurayura_sys_role_permission` VALUES ('3', '19');
INSERT INTO `yurayura_sys_role_permission` VALUES ('3', '20');
INSERT INTO `yurayura_sys_role_permission` VALUES ('4', '21');
INSERT INTO `yurayura_sys_role_permission` VALUES ('4', '22');
...
INSERT INTO `yurayura_sys_permission` VALUES ('4', 'sys_menu_delete', '菜单管理删除', '2', '1', 'sys_menu', '4');
INSERT INTO `yurayura_sys_permission` VALUES ('5', 'sys_dict_select', '数据字典管理查看', '1', '1', 'sys_dict', '1');
INSERT INTO `yurayura_sys_permission` VALUES ('6', 'sys_dict_insert', '数据字典管理添加', '2', '1', 'sys_dict', '2');
INSERT INTO `yurayura_sys_permission` VALUES ('7', 'sys_dict_update', '数据字典管理修改', '2', '1', 'sys_dict', '3');
INSERT INTO `yurayura_sys_permission` VALUES ('8', 'sys_manager_select', '管理员管理查看', '1', '1', 'sys_manager', '1');
INSERT INTO `yurayura_sys_permission` VALUES ('9', 'sys_manager_insert', '管理员管理添加', '2', '1', 'sys_manager', '2');
INSERT INTO `yurayura_sys_permission` VALUES ('10', 'sys_manager_update', '管理员管理修改', '2', '1', 'sys_manager', '3');
INSERT INTO `yurayura_sys_permission` VALUES ('11', 'sys_role_select', '角色管理查看', '1', '1', 'sys_role', '1');
INSERT INTO `yurayura_sys_permission` VALUES ('12', 'sys_role_insert', '角色管理添加', '2', '1', 'sys_role', '2');
INSERT INTO `yurayura_sys_permission` VALUES ('13', 'sys_role_update', '角色管理修改', '2', '1', 'sys_role', '3');
INSERT INTO `yurayura_sys_permission` VALUES ('14', 'sys_permission_select', '权限管理查看', '1', '1', 'sys_permission', '1');
INSERT INTO `yurayura_sys_permission` VALUES ('15', 'sys_permission_insert', '权限管理添加', '2', '1', 'sys_permission', '2');
INSERT INTO `yurayura_sys_permission` VALUES ('16', 'sys_permission_update', '权限管理修改', '2', '1', 'sys_permission', '3');
INSERT INTO `yurayura_sys_permission` VALUES ('17', 'comic_info_select', '番剧信息管理查看', '1', '1', 'comic_info', '1');
INSERT INTO `yurayura_sys_permission` VALUES ('18', 'comic_info_insert', '番剧信息管理添加', '2', '1', 'comic_info', '2');
INSERT INTO `yurayura_sys_permission` VALUES ('19', 'comic_info_update', '番剧信息管理修改', '2', '1', 'comic_info', '3');
INSERT INTO `yurayura_sys_permission` VALUES ('20', 'comic_info_deleteBatch', '番剧信息管理批量删除', '2', '1', 'comic_info', '4');
INSERT INTO `yurayura_sys_permission` VALUES ('21', 'user_info_select', '用户资料管理查看', '1', '1', 'user_info', '1');
INSERT INTO `yurayura_sys_permission` VALUES ('22', 'user_info_update', '用户资料管理修改', '2', '1', 'user_info', '2');
...
INSERT INTO `yurayura_sys_menu_sub` VALUES ('4', '角色管理', 'sys_role', '/business/sys_role', 'fa fa-users fa-lg', '1', '2', '4', '1');
INSERT INTO `yurayura_sys_menu_sub` VALUES ('5', '权限管理', 'sys_permission', '/business/sys_permission', 'fa fa-key fa-lg', '1', '2', '5', '1');
INSERT INTO `yurayura_sys_menu_sub` VALUES ('6', '番剧信息管理', 'comic_info', '/business/comic_info', 'fa fa-github-alt fa-lg', '2', '2', '1', '1');
INSERT INTO `yurayura_sys_menu_sub` VALUES ('7', '用户资料管理', 'user_info', '/business/user_info', 'fa fa-address-card fa-lg', '3', '2', '1', '1');
